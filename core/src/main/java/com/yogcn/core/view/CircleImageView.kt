...
class CircleImageView : YogcnImageView {
     ...
     */
    var fillColor: Int
        @Deprecated("Fill color support is going to be removed in the future") get() = mFillColor
        @Deprecated("Fill color support is going to be removed in the future") set(@ColorInt fillColor) {
